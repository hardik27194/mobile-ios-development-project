...
{
    ImageSingleton* s ;
    s= [ImageSingleton sharedSingletonInstance];
    [self dismissViewControllerAnimated:YES completion:nil];
    s.imageInfo=info;
    UIImage *image = [info objectForKey:UIImagePickerControllerOriginalImage];
//    NSLog(@"%@", [self getPixelColorAtLocation:CGPointMake(100, 100) withImage:image]);
//    self.view.backgroundColor = [self getPixelColorAtLocation:CGPointMake(100, 100) withImage:image];
